...
from summer3.computegraph.types import Variable, Function, Data, GraphObject
from summer3.computegraph.utils import is_var
...
def freeze_graph(
    ...
    dyn_sources = set(
        [p.node_name if isinstance(p, Variable) else p for p in dyn_sources]
    )
