...
from summer3.computegraph.jaxify import get_modules
...
class Function(GraphObject):
    ...
    def __init__(
        self, func: callable, args: tuple = None, kwargs: dict = None, name=None
    ):
        self.func = func
        if args is None:
            args = ()
...
class LazyClass(GraphObject):
    def __init__(self, ref_node: GraphObject):
        self._ref = ref_node
